...
export function DitheringShader({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (u.u_resolution) ctx.uniform2f(u.u_resolution, canvas.width, canvas.height)
      ...
      if (u.u_shape) ctx.uniform1f(u.u_shape, DitheringShapes[shape])
      if (u.u_type) ctx.uniform1f(u.u_type, DitheringTypes[type])
